...
<body class="bg-light">
    <div class="container" align="center">
        <img style="margin-top: 10%;" src="<?php echo base_url('assets/Lami logo.png')?>" style="height: 80px;width: 280px;">
    </div>
    <div class="wrapper">
        <form action="<?php echo site_url('sistem/aksi_login')?>" method="post">
            ...
            <p style="margin-left: 40%;">belum punya akun? <a href="<?php echo site_url('sistem/index2')?>" class="text-dark">register</a></p>
        </form>
    </div>
